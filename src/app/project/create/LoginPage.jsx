      ...
      <div className="max-w-md w-full bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
        <div className="p-8">
          <div className="text-center">
            <div className="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-indigo-900 mb-6">
            ...
            <p className="text-gray-400 mb-8">Please login to contribute to our community</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="text-center">
              <p className="text-sm text-gray-500 mb-2">or return to the home page</p>
              <a 
                href="/" 
                className="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-600 shadow-sm text-sm font-medium rounded-md text-gray-300 bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors"
              >
        ...
        <div className="bg-gray-900 bg-opacity-50 py-4 px-6 text-center">
          <p className="text-xs text-gray-500">You need proper credentials to contribute content to this platform</p>
        </div>
      </div>
      
      <div className="mt-8 text-center">
        <p className="text-sm text-gray-600">© 2023 Your App Name. All rights reserved.</p>
      </div>
    </div>
  );
}
